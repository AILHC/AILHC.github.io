...
1. 负责战斗，加载等的性能和内存优化，提高游玩流畅度;
2. 负责音频模块升级开发（接入wwise，重构音频模块），提高玩家的音乐音效体验;
3. 研究AMD FSR技术并接入项目使用，提高游戏性能。

**业绩**

1. 性能和内存的优化，满足了代理方（字节）对游戏在各个机型上的性能和内存要求，提高留存;
2. FSR技术的接入，在高分辨率下以较低的画质牺牲获得较高性能优化;
3. 音频模块的升级，让音乐音效品质和体验都得到了较高的提升。

**个人收获**

1. 将之前的H5游戏开发经验迁移到U3D手游上，验证，并通用
...
1. `EasyGameFramework`(跨引擎开发框架、H5游戏前端技术中台框架)
    1. github链接:https://github.com/AILHC/EasyGameFrameworkOpen
    2. 不翻墙链接:https://hub.fastgit.org/AILHC/EasyGameFrameworkOpen
2. 解决`CocosCreator`开发大型项目卡顿的插件:https://store.cocos.com/app/detail/2948
